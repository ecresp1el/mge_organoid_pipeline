...
main <- function() {
  ...
  readme <- c(
    ...
    "",
    "This run saves true Seurat whole-Shi TransferAnchorSet assets for the selected Varela query study.",
    ...
    "- One whole-Shi TransferAnchorSet is generated per query study.",
    "- That anchor object is shared for downstream Shi major cell-type and Shi GW/stage interpretation.",
    "- The anchor-pair tables explicitly include both reference_shi_label and reference_shi_week_label.",
    "- reference_shi_label supports cell-type views such as MGE, LGE, CGE, progenitor, OPC, etc.",
    "- reference_shi_week_label supports GW/stage views such as GW09, GW12, GW13, GW16, GW18.",
