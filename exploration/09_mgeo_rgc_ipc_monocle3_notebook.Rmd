...
pt_scaled <- scale_to_unit(umap_df$pseudotime)
...
umap_grid <- ggplot(umap_panel_df, aes(UMAP_1, UMAP_2)) +
  geom_point(aes(color = value_scaled), size = 0.08, alpha = 0.9, stroke = 0) +
  geom_segment(
    data = graph_edges,
  ...
  scale_color_gradientn(
    colors = c("grey90", "#3b528b", "#21918c", "#5ec962", "#fde725"),
    limits = c(0, 1),
    na.value = "grey92",
    name = "scaled value"
  ) +
