    ...
    def _report(self, cluster_by_stage: Sequence[Mapping[str, object]]) -> str:
        ...
        return "\n".join([
            ...
            *table,
            ...
            "",
            "It still does **not** identify CA301 alone. The public plot data exposed to the client distinguish `study`, `stage`, `cluster`, and `class`, but not Bandler sample ID or MGE/CGE/LGE region. Therefore the 7,420 E15 Bandler cells pool the E15.5 samples CA301 (MGE), CA302 (CGE), and CA303 (LGE). These counts must not be relabeled as 7,420 MGE cells.",
            "",
    ...
    def publish(self) -> None:
        ...
        atomic_tsv(
            ...
            (
                ...
                {"resource": "CA301 sample or MGE/CGE/LGE membership", "available_through_intended_public_app": "no", "captured": "no", "interpretation": "Public fields pool Bandler samples within stage."},
