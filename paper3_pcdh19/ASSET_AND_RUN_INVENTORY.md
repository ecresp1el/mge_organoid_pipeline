...
| `primary_processing/01a_qc_mad_sensitivity` | Exact in-review Step 01 cell-level QC metadata | Object-oriented code and frozen-run infrastructure implemented; authorized for execution | Per-technical-sample 3/4/5 scaled-MAD candidate sensitivity, boundary/flag/overlap tables and plots only; no design-group definition, upper count/gene rules, filtering, or replacement H5AD. |
