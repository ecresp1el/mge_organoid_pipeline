...
| `00_developing_mouse_mge_reference_curation` | Published processed objects plus published and object-linked sample/library metadata for La Manno 2021, Bandler 2022, and Mayer 2018 | First checkpoint complete on 2026-08-29; Bandler follow-ups recovered a separate 65,700-cell postnatal STICR Seurat object, official supplements, and intended public later-atlas vector outputs | Bandler supplies 4,516 WT E15.5 MGE count-matrix cells. The later atlas contains 18,424 labeled Bandler cells (11,004 E13; 7,420 E15), but its E15 field pools CA301 MGE/CA302 CGE/CA303 LGE and still lacks a CA301 join. Mayer supplies 6,515 MGE E13.5 Lhx6-positive cells; La Manno E15 MGE membership is unproven. Stop before final selection or Paper 3 mapping. |
...
| Reference-curation implementation | Main curation, Bandler recovery/inspection/supplement-publishing, public-atlas capture/vector-counting, hierarchy/report scripts, `config/developing_mouse_mge_*`, submit/status wrappers, and `slurm/00a-00f_*.sbatch` | Object-oriented registry/cache, metadata parsing, H5AD/RDS/CSV inspection, reconciliation, public Shiny output capture, vector count validation, artifact-scope evaluation, supplement extraction, hierarchy plotting, and report publication. It records published versus object-linked IDs/counts, biological/library fields, exact observed labels, explicit gaps, and later-atlas evidence. Submission freezes executable copies and supports confined same-step overwriting. |
