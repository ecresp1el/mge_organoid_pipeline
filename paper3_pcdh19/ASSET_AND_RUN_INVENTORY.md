...
| `primary_processing/00_input_validation_and_canonical_anndata` | Canonical sparse raw-count AnnData from 12 per-sample filtered Cell Ranger matrices | Run `00_input_validation_and_canonical_anndata_20260830_113749_d8b6bf7`; job `59279775` complete; 221/221 checks pass; status `IN_REVIEW` | 450,788 cells × 19,071 genes; 1,295,361,777 nonzeros; raw integer counts in `.X`; no filtering, normalization, reduction, clustering, annotation, or downstream-label join. |
