...
| `primary_processing/01_qc_metrics` | Approved Step 00 counts plus Scanpy QC metadata | Run `01_qc_metrics_20260830_115715_2b57907`; job `59281063` complete; 40/40 checks pass; `IN_REVIEW` | 450,788 cells × 19,071 genes retained with exact sparse-matrix fingerprint; 15 PNG plus 15 PDF diagnostics; no thresholds, filtering, normalization, reduction, clustering, or annotation. |
| `primary_processing/01a_qc_mad_sensitivity` | Exact in-review Step 01 cell-level QC metadata | Review-target run `01a_qc_mad_sensitivity_20260830_121931_d5936f9`; job `59282437` complete; 71/71 checks pass; `IN_REVIEW` | Per-technical-sample 3/4/5 scaled-MAD any-candidate rates 4.765%/2.024%/0.985%, dominated by the mitochondrial tail; 30 figures and complete per-cell/summary/overlap tables; no design grouping, upper count/gene rules, filtering, or replacement H5AD. |
