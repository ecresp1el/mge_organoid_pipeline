...
| `primary_processing/01_qc_metrics` | Approved Step 00 counts plus Scanpy QC metadata | Object-oriented code and frozen-run infrastructure implemented; authorized for execution | Metrics and plots only; retain all cells/genes/counts; no thresholds, filtering, normalization, reduction, clustering, or annotation. |
