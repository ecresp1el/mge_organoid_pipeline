...
def common_initial_urd() -> list[ExpectedArtifact]:
    return [
        ...
        ExpectedArtifact("tables/div30_first_urd_checkpoint_manifest.tsv", "initial_urd", "table", True, "Resumable checkpoint manifest for shared URD geometry stages."),
        ExpectedArtifact("checkpoints/urd_after_filter.rds", "initial_urd_checkpoint", "rds", False, "Optional resumable checkpoint after filtering."),
        ExpectedArtifact("checkpoints/urd_after_variable_genes.rds", "initial_urd_checkpoint", "rds", False, "Optional resumable checkpoint after variable-gene selection."),
        ExpectedArtifact("checkpoints/urd_after_pca.rds", "initial_urd_checkpoint", "rds", False, "Optional resumable checkpoint after PCA."),
        ExpectedArtifact("checkpoints/urd_after_diffusion_map.rds", "initial_urd_checkpoint", "rds", False, "Optional resumable checkpoint after diffusion map."),
        ExpectedArtifact("checkpoints/urd_after_flood_pseudotime.rds", "initial_urd_checkpoint", "rds", False, "Optional resumable checkpoint after flood pseudotime."),
